...
class Curl {
    ...
    public function exec($ch = null) {
        ...
        if (!($ch === null)) {
            ...
            $this->rawResponse = curl_exec(self::$curl);
            $this->curlErrorCode = curl_errno(self::$curl);
        }
        $this->curlErrorMessage = curl_error(self::$curl);
        $this->curlError = !($this->curlErrorCode === 0);
        $this->httpStatusCode = curl_getinfo(self::$curl, CURLINFO_HTTP_CODE);
        ...
        if ($this->getOpt(CURLINFO_HEADER_OUT) === true) {
            $this->requestHeaders = $this->parseRequestHeaders(curl_getinfo(self::$curl, CURLINFO_HEADER_OUT));
        }
